...
class RSequenceGenerator:
    ...
    def __init__(self, dims, seed=0.5):
        ...
        # NOTE: If necessary, we could preprocess a ton of values here and simply read from them during runtime.
        #       For example, preprocessing 10000000 values would be more than enough I think, and we can then just
        #       read from the array forever with modulo...
